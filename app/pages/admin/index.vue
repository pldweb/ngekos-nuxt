...
const menu = [
  ...
  { label: 'Laporan', icon: 'pi pi-chart-bar', to: '/admin/laporan' },
  { label: 'Kos Harian', icon: 'pi pi-calendar', to: '/admin/harian' },
  { label: 'Pengaturan', icon: 'pi pi-cog', to: '/admin/pengaturan' },
